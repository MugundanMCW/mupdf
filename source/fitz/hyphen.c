...
#ifdef _M_ARM64
// Disable embedded hyphenation resources for ARM64 due to alignment issues with bin2coff
// Hyphenation can still be enabled by loading external dictionaries
